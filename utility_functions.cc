...
//pol6 fit
/*        double f_s_neu = -0.00146609+0.00589747*E+0.0108878*std::pow(E,2)-0.00174571*std::pow(E,3)+4.97905e-05*std::pow(E,4)+3.15376e-06*std::pow(E,5)-1.37052e-07*std::pow(E,6);//pol6 fit with chi square = 0.00013515
*/

//pol7 fit;
/*       double f_s_neu = -0.000197235+0.00153566*E+0.0144615*std::pow(E,2)-0.00294727*std::pow(E,3)+0.00024954*std::pow(E,4)-1.42247e-05*std::pow(E,5)+6.21019e-07*std::pow(E,6)-1.30792e-08*std::pow(E,7); chi square = 4.0061e-05
*/
        //return std::abs(f_s_neu);
...
////////////////////////////////////////
//Fit returns 0 when energy is "wrong"//
////////////////////////////////////////

//        double f_s_neu = -0.00146609+0.00589747*E+0.0108878*std::pow(E,2)-0.00174571*std::pow(E,3)+4.97905e-05*std::pow(E,4)+3.15376e-06*std::pow(E,5)-1.37052e-07*std::pow(E,6);//pol6 fit with chi square = 0.00013515
//        if(f_s_neu<0){f_s_neu=0;}

//////////////////
//Period fitting//
//////////////////

/*        double f_s_neu = -0.00146609+0.00589747*E+0.0108878*std::pow(E,2)-0.00174571*std::pow(E,3)+4.97905e-05*std::pow(E,4)+3.15376e-06*std::pow(E,5)-1.37052e-07*std::pow(E,6); if (E < 14.42 && E > 0.2)
        if (E < 14.42 && E > 0.2{
          return std::abs(f_s_neu);
        }
        else if (E > 14.42){
